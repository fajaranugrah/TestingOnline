...
public class SoalQuizSMPActivity extends Activity {
    ...
    private static String sent_url = "http://aplikasito.hol.es/sent_value.php?judul=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_quiz_smp);
        ...
        btnPrev = (Button) findViewById(R.id.buttonPrev1);
        btnSelesai = (Button) findViewById(R.id.buttonSelesai1);
        btnNext = (Button) findViewById(R.id.buttonNext1);
        rg = (RadioGroup) findViewById(R.id.radioGroup1);
        rb1 = (RadioButton) findViewById(R.id.radio5);
        rb2 = (RadioButton) findViewById(R.id.radio6);
        rb3 = (RadioButton) findViewById(R.id.radio7);
        rb4 = (RadioButton) findViewById(R.id.radio8);
        ...
        tampilkandialog = new AlertDialog.Builder(SoalQuizSMPActivity.this).create();
    ...
    public class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SoalQuizSMPActivity.this);
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(SoalQuizSMPActivity.this).create();
    ...
    private void resume(){
        long millisInfuturesss = Reminingtime;
        long coundownInterval = 1000;
        new CountDownTimer(millisInfuturesss, coundownInterval){
    ...
    private void saveNilai(){
        ...
        String SENT_URLs = sent_url + "&email=" + email_ans + "&nilai=" + nilai + "&judul=" + judul_ans + "&email_mak=" + email_bu;
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET, SENT_URLs, new Response.Listener<String>(){
            public void onResponse(String response) {
                Log.d(SoalQuizSMPActivity.class.getSimpleName(), "Save Value Succed: " + response.toString());
            }}, new Response.ErrorListener() {

            @Override
            public void onErrorResponse(VolleyError error) {
                Log.e(SoalQuizSMPActivity.class.getSimpleName(), "Save Value Error: " + error.getMessage());
