...
public class SoalQuizGENERALActivity extends Activity {
    ...
    private static String sent_urlsss = "http://aplikasito.hol.es/sent_value.php?judul=";
    ...
    long Reminingtimessss;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_soal_quiz_general);
        ...
        btnSelesai = (Button) findViewById(R.id.buttonSelesai4);
        btnNext = (Button) findViewById(R.id.buttonNext4);
        rg = (RadioGroup) findViewById(R.id.radioGroup1);
        rb1 = (RadioButton) findViewById(R.id.radio13);
        rb2 = (RadioButton) findViewById(R.id.radio14);
        rb3 = (RadioButton) findViewById(R.id.radio15);
        rb4 = (RadioButton) findViewById(R.id.radio16);
        ...
        tampilkandialog = new AlertDialog.Builder(SoalQuizGENERALActivity.this).create();
    ...
    public class GetSoal extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SoalQuizGENERALActivity.this);
    ...
    private void tunjukanPertanyaan(int urutan_soal_soal, boolean review) {
        ...
        try {
            ...
            imageLoader.DisplayImage(soal.getGambar(), imge);
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(SoalQuizGENERALActivity.this).create();
    ...
    public class CounterClass extends CountDownTimer {
        ...
        public void onTick(long millisUntilFinished) {
            ...
            Reminingtimessss = millisUntilFinished;
        }
    }
    ...
    private void resume(){
        long millisInfuture = Reminingtimessss;
        long coundownInterval = 1000;
        new CountDownTimer(millisInfuture, coundownInterval){
    ...
    private void saveNilai(){
        ...
        String SENT_URL = sent_urlsss + "&email=" + email_ans + "&nilai=" + nilai + "&judul=" + judul_ans + "&email_mak=" + email_bu;

        // Tag used to cancel the request
        String tag_string_req = "req_login";

        StringRequest strReq = new StringRequest(Request.Method.GET, SENT_URL, new Response.Listener<String>(){
            public void onResponse(String response) {
                Log.d(SoalQuizGENERALActivity.class.getSimpleName(), "Save Value Succed: " + response.toString());
            }}, new Response.ErrorListener() {

            @Override
            public void onErrorResponse(VolleyError error) {
                Log.e(SoalQuizGENERALActivity.class.getSimpleName(), "Save Value Error: " + error.getMessage());
